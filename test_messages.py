...
def test_message_generation():
    ...
    if recommendations:
        ...
        mensaje_final = mark_safe(f'<div class="crawl-message {message_class}">{mensaje}</div>{recommendations_html}')
    else:
        mensaje_final = mark_safe(f'<div class="crawl-message {message_class}">{mensaje}</div>')
